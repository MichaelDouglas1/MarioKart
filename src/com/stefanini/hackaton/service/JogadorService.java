...
public class JogadorService {
	...
	public List<JogadorDto> cadastrar(CadastroJogadorDto cadastro) throws NegocioException {
		...
		if (cadastro.getNickname() == null || cadastro.getNickname().equals("") || cadastro.getNickname().length() <= 0
		...
		// throw new NegocioException("A senha deve possuir o tamanho entre 6 ou 8
		// caracteres!");
